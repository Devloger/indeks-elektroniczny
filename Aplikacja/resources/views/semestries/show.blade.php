...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <form action="{{ url('/semestries') }}" method="POST" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="wartosc" id="wartosc" class="form-control" value="{{$model['wartosc'] or ''}}" readonly="readonly">
            </div>
        </div>
