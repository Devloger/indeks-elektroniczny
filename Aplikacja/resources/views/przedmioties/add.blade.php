...
<h2 class="page-header">Przedmioty</h2>

<div class="panel panel-default">
    <div class="panel-heading">
        Dodaj/Zmodyfikuj Przedmioty    </div>

    <div class="panel-body">
                
        <form action="{{ url('/przedmioties'.( isset($model) ? "/" . $model->id : "")) }}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-6">
                    ...
                    <a class="btn btn-default" href="{{ url('/przedmioties') }}"><i class="glyphicon glyphicon-chevron-left"></i> Wróć</a>
                </div>
            </div>
        </form>
