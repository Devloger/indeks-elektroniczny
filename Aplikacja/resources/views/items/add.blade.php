...
<h2 class="page-header">Item</h2>

<div class="panel panel-default">
    <div class="panel-heading">
        Dodaj/Zmodyfikuj Item    </div>

    <div class="panel-body">
                
        <form action="{{ url('/items'.( isset($model) ? "/" . $model->id : "")) }}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-6">
                    ...
                    <a class="btn btn-default" href="{{ url('/items') }}"><i class="glyphicon glyphicon-chevron-left"></i> Cofnij</a>
                </div>
            </div>
        </form>
