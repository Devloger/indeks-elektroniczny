...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="birth" id="birth" class="form-control" value="{{$model['birth'] or ''}}" readonly="readonly">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="register" id="register" class="form-control" value="{{$model['register'] or ''}}" readonly="readonly">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="semester_id" id="semester_id" class="form-control" value="{{$model['semester_id'] or ''}}" readonly="readonly">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="direction_id" id="direction_id" class="form-control" value="{{$model['direction_id'] or ''}}" readonly="readonly">
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-offset-3 col-sm-6">
                <a class="btn btn-default" href="{{ url('/students') }}"><i class="glyphicon glyphicon-chevron-left"></i> Wróć</a>
            </div>
        </div>
