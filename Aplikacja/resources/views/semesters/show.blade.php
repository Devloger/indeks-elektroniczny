...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <form action="{{ url('/semesters') }}" method="POST" class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-offset-3 col-sm-6">
                <a class="btn btn-default" href="{{ url('/semesters') }}"><i class="glyphicon glyphicon-chevron-left"></i> Wróć</a>
            </div>
        </div>
