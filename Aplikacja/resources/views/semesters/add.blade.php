...
<div class="panel panel-default">
    <div class="panel-heading">
        Dodaj/Zmodyfikuj Semester    </div>

    <div class="panel-body">
                
        <form action="{{ url('/semesters'.( isset($model) ? "/" . $model->id : "")) }}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            ...
            @endif
                ...
                <div class="col-sm-2">
                    <input type="number" name="value" id="value" class="form-control" value="{{$model['value'] or ''}}">
                </div>
            </div>
                                                                                                                        <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-6">
                    ...
                    <a class="btn btn-default" href="{{ url('/semesters') }}"><i class="glyphicon glyphicon-chevron-left"></i> Cofnij</a>
                </div>
            </div>
        </form>
